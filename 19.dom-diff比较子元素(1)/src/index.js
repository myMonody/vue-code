...
let render1 = compilerToFunction(`
  <div>
  <li data="a" style="background:red">A</li>
  <li data="b" style="background:blue">B</li>
  <li data="c" style="background:gray">C</li>
  <li data="d" style="background:purple">D</li>
  </div>`);
...
let render2 = compilerToFunction(`
  <div>
  <li style="background:skyblue">E</li>
  <li data="a" style="background:red">A</li>
  <li data="b" style="background:blue">B</li>
  <li data="c" style="background:gray">C</li>
  <li data="d" style="background:purple">D</li>
  <li style="background:yellow">E</li>
  </div>`);
